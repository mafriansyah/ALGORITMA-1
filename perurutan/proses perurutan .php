...
<div class="login-container">
    ...
    <div class="welcome-message1"><h4>Di Program Project Perurutan Notasi Algoritma <h4></div>
    

<strong style="-webkit-text-fill-color: blue; text-transform:uppercase"></strong> 

<form method="GET" action="output perurutan .php">

  <label for="Input Perulangan Rian">Input Perurutan Rian:</label>
